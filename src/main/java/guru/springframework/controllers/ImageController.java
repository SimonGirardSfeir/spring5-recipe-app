...
public class ImageController {
    ...
    public String getImageForm(@PathVariable String idRecipe, Model model) {

        model.addAttribute("recipe", recipeService.findCommandById(Long.parseLong(idRecipe)));
    ...
    public String handleImagePost(@PathVariable String idRecipe, @RequestParam("imagefile") MultipartFile file) {
        ...
        imageService.saveImageFile(Long.parseLong(idRecipe), file);
    ...
    public void renderImageFromDB(@PathVariable String idRecipe, HttpServletResponse response) throws IOException {
        RecipeCommand recipeCommand = recipeService.findCommandById(Long.parseLong(idRecipe));
